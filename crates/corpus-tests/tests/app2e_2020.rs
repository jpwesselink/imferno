//! App2E 2020 constraint validation tests against the vendored corpus.
//!
//!
...
/// The validator rejects it; our validator maps it to Unknown → not J2K family → error.
#[test]
...
/// Per spec: HT was added only in 2021.
#[test]
...
/// IMF 4K requires width in (2048, 4096].
#[test]
