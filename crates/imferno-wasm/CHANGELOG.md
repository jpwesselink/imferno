...
## [3.1.0](https://github.com/jpwesselink/imferno/compare/imferno-wasm-v3.0.1...imferno-wasm-v3.1.0) - 2026-07-18

### Added

- *(validation)* audit P3 batch — IAB §5.10.2/Annex C.2/§6.2 and ISXD §6/§9.3 gap rules, font/otf (AUDIT-18, AUDIT-21, AUDIT-13 partial)
...
- *(validation)* audit P2 batch — 9 spec-conformance findings across audio MCA, IAB, ISXD
...
## [2.4.1](https://github.com/jpwesselink/imferno/compare/imferno-wasm-v2.4.0...imferno-wasm-v2.4.1) - 2026-05-18
...
## [2.4.0](https://github.com/jpwesselink/imferno/compare/imferno-wasm-v2.1.2...imferno-wasm-v2.4.0) - 2026-05-11
