...
console.log(result.report.is_compliant);
...
```javascript
const result = validatePath('./my-imp', { verifyHashes: true });
```
...
See the [Validation Codes](/reference/codes/st2067-2/) reference for the full catalogue.
