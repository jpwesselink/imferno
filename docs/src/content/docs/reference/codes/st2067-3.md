...
use imferno_core::codes::{St2067_3_2013, St2067_3_2016, St2067_3_2020};
```
...
codes.ST2067_3_2013; // all codes in this group
codes.ST2067_3_2016; // all codes in this group
codes.ST2067_3_2020; // all codes in this group
```
