/* tslint:disable */
/* eslint-disable */
export interface ADMAudioSequence {
    id: ImfUuid;
    trackId: ImfUuid;
    resourceList: ResourceList;
}

export interface ADMAudioVirtualTrackParameterSet {
    id: ImfUuid;
    trackId: ImfUuid;
    admOperationalMode: string;
    admSoundfieldGroupSelectors?: ADMSoundfieldGroupSelector[];
}

export interface ADMSoundfieldGroupSelector {
    resourceId: ImfUuid;
    admSoundfieldGroupLinkIds: ImfUuid[];
}
...
export interface ExtensionProperties {
    ...
    maxCLL?: number | null;
    maxFALL?: number | null;
    mgaSadmVirtualTrackParameterSets?: MGASADMVirtualTrackParameterSet[];
    admAudioVirtualTrackParameterSets?: ADMAudioVirtualTrackParameterSet[];
}
...
export interface MGASADMSignalSequence {
    id: ImfUuid;
    trackId: ImfUuid;
    resourceList: ResourceList;
}

export interface MGASADMSoundfieldGroupSelector {
    resourceId: ImfUuid;
    mgaSoundfieldGroupLinkIds: ImfUuid[];
}

export interface MGASADMVirtualTrackParameterSet {
    id: ImfUuid;
    trackId: ImfUuid;
    mgaSadmOperationalMode: string;
    mgaSadmSoundfieldGroupSelectors?: MGASADMSoundfieldGroupSelector[];
}
...
export interface SequenceList {
    ...
    mgaSadmSignalSequences?: MGASADMSignalSequence[];
    admAudioSequences?: ADMAudioSequence[];
}
